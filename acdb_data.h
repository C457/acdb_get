...
enum {
    ...
    SND_DEVICE_IN_VOICE_HEADPHONE_MIC,
...
static char * device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_SPEAKER_OFF_DOLBY] = "SND_DEVICE_OUT_SPEAKER_OFF_DOLBY",
    [SND_DEVICE_OUT_SPEAKER_AKM] = "SND_DEVICE_OUT_SPEAKER_AKM",
    [SND_DEVICE_OUT_SPEAKER_AKM_OFF_DOLBY] = "SND_DEVICE_OUT_SPEAKER_AKM_OFF_DOLBY",
    ...
    [SND_DEVICE_OUT_HEADPHONES_HI_FI] = "SND_DEVICE_OUT_HEADPHONES_HI_FI",
    [SND_DEVICE_OUT_HEADPHONES_OFF_DOLBY] = "SND_DEVICE_OUT_HEADPHONES_OFF_DOLBY",
    ...
    [SND_DEVICE_IN_TEST_BOTTOM_MIC] = "SND_DEVICE_IN_TEST_BOTTOM_MIC",
    [SND_DEVICE_IN_TEST_TOP_MIC] = "SND_DEVICE_IN_TEST_TOP_MIC",
    [SND_DEVICE_IN_TEST_ASSIST_BOTTOM_MIC] = "SND_DEVICE_IN_TEST_ASSIST_BOTTOM_MIC",
    [SND_DEVICE_IN_STEREO_RECORD_MIC] = "SND_DEVICE_IN_STEREO_RECORD_MIC",
    [SND_DEVICE_IN_DIRECTION_RECORD_MIC] = "SND_DEVICE_IN_DIRECTION_RECORD_MIC",
    [SND_DEVICE_IN_TRANSLATION_WORD_RECORD_MIC] = "SND_DEVICE_IN_TRANSLATION_WORD_RECORD_MIC",
    [SND_DEVICE_IN_HIFI_RECORD_MIC] = "SND_DEVICE_IN_HIFI_RECORD_MIC",
    [SND_DEVICE_IN_FARAWAY_RECORD_MIC] = "SND_DEVICE_IN_FARAWAY_RECORD_MIC",
    [SND_DEVICE_IN_RECOGNITION_FAR_TALK_DMIC] = "SND_DEVICE_IN_RECOGNITION_FAR_TALK_DMIC",
    [SND_DEVICE_IN_BARGE_IN_SPK_MIC] = "SND_DEVICE_IN_BARGE_IN_SPK_MIC",
    [SND_DEVICE_IN_BARGE_IN_HEADPHONE_MIC] = "SND_DEVICE_IN_BARGE_IN_HEADPHONE_MIC",
    [SND_DEVICE_IN_BARGE_IN_HEADPHONE_AND_SPEAKER_MIC] = "SND_DEVICE_IN_BARGE_IN_HEADPHONE_AND_SPEAKER_MIC",
    [SND_DEVICE_IN_BARGE_IN_HEADSET_AND_SPEAKER_MIC] = "SND_DEVICE_IN_BARGE_IN_HEADSET_AND_SPEAKER_MIC",
    ...
    [SND_DEVICE_IN_HEADSET_WECHAT_MIC] = "SND_DEVICE_IN_HEADSET_WECHAT_MIC",
    ...
    [SND_DEVICE_IN_VOICE_HANDSET_MIC] = "SND_DEVICE_IN_VOICE_HANDSET_MIC",
    [SND_DEVICE_IN_VOICE_HEADPHONE_MIC] = "SND_DEVICE_IN_VOICE_HEADPHONE_MIC",
    ...
    [SND_DEVICE_IN_VOICE_SPEAKER_MIC_LOOP] = "SND_DEVICE_IN_VOICE_SPEAKER_MIC_LOOP",
    [SND_DEVICE_IN_CAPTURE_MAIN_MIC] = "SND_DEVICE_IN_CAPTURE_MAIN_MIC",
    [SND_DEVICE_IN_CAPTURE_AUX_MIC] = "SND_DEVICE_IN_CAPTURE_AUX_MIC",
};
